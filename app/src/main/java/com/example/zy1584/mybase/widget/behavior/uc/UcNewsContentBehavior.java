package com.example.zy1584.mybase.widget.behavior.uc;
...
import com.example.zy1584.mybase.widget.behavior.helper.HeaderScrollingViewBehavior;
...
public class UcNewsContentBehavior extends HeaderScrollingViewBehavior {
    ...
    private int getFinalHeight() {
        return BaseApplication.getContext().getResources().getDimensionPixelOffset(R.dimen.uc_news_tabs_height) + BaseApplication.getContext().getResources().getDimensionPixelOffset(R.dimen.uc_news_header_title_height);
    }
