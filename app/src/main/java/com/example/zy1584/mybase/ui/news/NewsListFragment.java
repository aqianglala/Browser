...
import com.example.zy1584.mybase.ui.main.adapter.RecyclerViewAdapter;
 ...
 */
public class NewsListFragment extends Fragment implements RecyclerViewAdapter.OnItemClickListener {
    ...
    public static NewsListFragment newInstance(String desc, boolean refreshSupport) {
    ...
    public static NewsListFragment newInstance(String desc) {
