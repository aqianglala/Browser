...
//
//import static com.example.zy1584.mybase.utils.UIUtils.runOnUiThread;
//
...
//        mContext = mActivity;
//        final RecyclerView recyclerView = (RecyclerView) mContentView.findViewById(R.id.recycler_view);
//
...
//                    setApkIcon(holder, model.getPath());
...
//
//                    File file = new File(TasksManager.getImpl().get(pos).getPath());
//                    File tempFile = new File(FileDownloadUtils.getTempPath(model.getPath()));
//
//                    if (file.exists()){
//                        file.delete();
//                    }
...
//        }
//
//        private void setApkIcon(TaskItemViewHolder holder,String path) {
...
//
//        private void registerServiceConnectionListener(final WeakReference<DownloadManagerFragment>
...
//        }
//
//        public void onCreate(final WeakReference<DownloadManagerFragment> activityWeakReference) {
