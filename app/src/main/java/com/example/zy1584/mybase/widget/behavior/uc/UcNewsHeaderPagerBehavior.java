...
import com.example.zy1584.mybase.widget.behavior.helper.ViewOffsetBehavior;
...
public class UcNewsHeaderPagerBehavior extends ViewOffsetBehavior {
    ...
    private void init() {
        mOverScroller = new OverScroller(BaseApplication.getContext());
    }
    ...
    protected void layoutChild(CoordinatorLayout parent, View child, int layoutDirection) {
        ...
        mViewPager = (NewsViewPager) parent.findViewById(R.id.id_uc_news_content);
    }
