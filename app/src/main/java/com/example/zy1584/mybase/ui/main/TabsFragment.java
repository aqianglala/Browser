...
public class TabsFragment extends BaseFragment implements MyAdapter.onSwipeDismissListener,
        MyAdapter.OnItemClickLitener{
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        initData();
        mAdapter = new MyAdapter(mActivity, mData);
