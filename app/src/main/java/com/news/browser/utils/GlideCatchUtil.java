...
import com.news.browser.config.GlideCatchConfig;
...
public class GlideCatchUtil {
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(BaseApplication.getContext().getCacheDir() + "/" + GlideCatchConfig.GLIDE_CACHE_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    public boolean cleanCacheDisk() {
        return deleteFolderFile(BaseApplication.getContext().getCacheDir() + "/" + GlideCatchConfig.GLIDE_CACHE_DIR, true);
    }
