...
public class BrowserChromeClient extends WebChromeClient {
    ...
    private static final String TAG = BrowserChromeClient.class.getSimpleName();
    ...
    public BrowserChromeClient(@NonNull Activity activity, @NonNull BrowserFragment fragment) {
    ...
    public void onGeolocationPermissionsShowPrompt(@NonNull final String origin,
        ...
        PermissionsManager.getInstance().requestPermissionsIfNecessaryForResult(mActivity, PERMISSIONS, new PermissionsResultAction() {
            ...
            public void onDenied(String permission) {
                //TODO showBrowserFragment message and/or turn off setting
            }
        });
    }
...
//        mUIController.showFileChooser(filePathCallback);
     ...
     * showBrowserFragment a loading dialog. Inflates a progress mContentView and returns it.
     *
