package com.news.browser.http.transformer;


import com.news.browser.http.exception.ExceptionEngine;
import com.news.browser.base.BaseHttpResult;
import com.news.browser.http.exception.ErrorType;
import com.news.browser.http.exception.ServerException;
